...
export interface AppUser {
  ...
  role: UserRole; // 'ploy' = คุณพลอย (Super Admin ดูและแก้ไขได้ทุกระบบ บันทึกลง Firebase เรียลไทม์) | 'owner' = เจ้าของหอพัก (คุณแม่) | 'caretaker' / 'user' = พนักงานดูแลหอพัก (ซ่อนข้อมูลเรื่องเงิน)
  isMom?: boolean;
  avatar?: string;
  phone?: string;
