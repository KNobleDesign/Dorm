...
export interface AppUser {
  ...
  role: UserRole; // 'ploy' = คุณพลอย (Owner & Super Admin เจ้าของและผู้ดูแลระบบ ดูและแก้ไขได้ทุกระบบ รวมถึงข้อมูลการเงินและรายรับ-รายจ่ายทั้งหมด) | 'owner' = เจ้าของหอพัก (คุณแม่) | 'caretaker' / 'user' = พนักงานดูแลหอพัก (ซ่อนข้อมูลเรื่องเงิน)
  isMom?: boolean;
  avatar?: string;
  phone?: string;
