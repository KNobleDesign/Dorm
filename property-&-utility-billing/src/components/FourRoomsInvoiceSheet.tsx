    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Tenant & Status Bar (Never wraps, clean single line with due date) */}
          <div
            style={{
              backgroundColor: '#f8fafc',
              padding: '6px 9px',
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', minWidth: 0, flexWrap: 'wrap' }}>
              {room.occupancyStatus === 'vacant' ? (
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', whiteSpace: 'nowrap', overflow: 'hidden' }}>
                  <span style={{ color: '#64748b', fontWeight: 600, fontSize: '11px' }}>ผู้เช่า:</span>
                  <strong
                    style={{
                      color: '#020617',
                      fontWeight: 800,
                  ...
                  <span style={{ color: '#475569', fontWeight: 500, fontSize: '11px' }}>
                    ({room.occupants || 1} คน{room.phone ? ` • โทร ${room.phone}` : ''})
                  </span>
                </div>
              )}
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexShrink: 0 }}>
              ...
              <div style={{ fontSize: '11px', color: '#475569', whiteSpace: 'nowrap', display: 'flex', alignItems: 'center', gap: '4px' }}>
