    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Tenant & Status Box (Full tenant name display, generous line space, zero truncation across all pages) */}
          <div
            style={{
              backgroundColor: '#f8fafc',
              padding: '6px 9px',
          ...
          >
            {/* Row 1: Dedicated Full Tenant Name Row (Generous space, no truncation, no ellipsis) */}
            <div
              style={{
                display: 'flex',
                justifyContent: 'space-between',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '5px', minWidth: 0, flex: 1 }}>
                    ...
                    <strong
                      style={{
                        color: '#020617',
                        fontWeight: 900,
                        fontSize: (room.tenantName && room.tenantName.length > 28) ? '12px' : '13.5px',
            ...
            {/* Row 2: Occupants, Phone & Due Date Badge (Clean, aligned, zero syllable breaks) */}
            <div
              style={{
                display: 'flex',
                justifyContent: 'space-between',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0, minWidth: 0 }}>
                {room.occupancyStatus === 'occupied' ? (
                  ...
                  <span style={{ fontSize: '10px', color: '#94a3b8', fontStyle: 'italic', whiteSpace: 'nowrap' }}>
                    {room.occupancyStatus === 'vacant' ? 'ห้องว่างพร้อมเข้าอยู่' : 'อยู่ระหว่างปรับปรุง'}
                  </span>
                )}
              </div>
        ...
        <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: '6px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
          {/* Bank & PromptPay Card (Rock-solid layout: no wrapping collisions, no overlaps, zero text collision) */}
          <div
            style={{
              padding: '6px 9px',
              borderRadius: '6px',
              border: paymentAccount.isHouseAccount ? '1px solid #d8b4fe' : '1px solid #e2e8f0',
          ...
          >
            {/* Row 1: Bank Name + Account Number (Left) & Account Label Tag (Right) */}
            <div
              style={{
                display: 'flex',
                justifyContent: 'space-between',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px', whiteSpace: 'nowrap', flexShrink: 0 }}>
                <span style={{ color: '#475569', fontWeight: 600, fontSize: '10.5px', whiteSpace: 'nowrap' }}>
                  {displayBankName}:
                </span>
                <strong
                  style={{
              ...
              {paymentAccount.accountLabel && (
                <span
                  style={{
                    ...
                    borderRadius: '4px',
                    backgroundColor: '#ffffff',
                    border: paymentAccount.isHouseAccount ? '1px solid #d8b4fe' : '1px solid #cbd5e1',
                    color: paymentAccount.isHouseAccount ? '#6b21a8' : '#334155',
                    whiteSpace: 'nowrap',
                    flexShrink: 0,
                    lineHeight: 1.3,
                    display: 'inline-block',
            ...
            {/* Row 2: PromptPay (Left) & Account Name (Right) */}
            <div
              style={{
                display: 'flex',
                justifyContent: 'space-between',
            ...
            >
              ...
              >
                <span style={{ color: '#64748b', fontWeight: 600, fontSize: '10.5px', whiteSpace: 'nowrap' }}>
                  ชื่อบัญชี:
                </span>
                <strong
                  style={{
                  ...
                  title={paymentAccount.accountName || '-'}
                >
          ...
          >
            {!isForExport && onTogglePaymentStatus ? (
              <button
                ...
                className={`px-2 py-0.5 rounded font-bold transition cursor-pointer print:border print:border-slate-300 shadow-2xs text-[10.5px] whitespace-nowrap flex-shrink-0 ${
                  room.isPaid
            ...
            <span style={{ fontSize: '10.5px', color: '#334155', fontWeight: 500, whiteSpace: 'nowrap', flexShrink: 0 }}>
              ผู้รับเงิน: ...........................
            </span>
          </div>
        </div>
