          ...
          return (
            ...
            >
              ...
              <div className="border-t border-slate-200 pt-1.5 space-y-1.5">
                ...
                <div className={`px-2.5 py-1.5 rounded-lg border text-xs space-y-1 ${
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-[10.5px] font-medium px-1.5 py-0.2 rounded bg-white/80 border border-slate-200 text-slate-700">
