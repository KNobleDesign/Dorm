    ...
    <div className="space-y-4 sm:space-y-6 pb-28 md:pb-8">
      ...
      {activeTabMode === 'walk-through' && (
        <div className="space-y-4">
          ...
          {/* Sticky Bottom Action Bar for Easy One-Thumb Save on Phone */}
          <div className="fixed bottom-0 left-0 right-0 z-30 p-3 bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-2xl">
