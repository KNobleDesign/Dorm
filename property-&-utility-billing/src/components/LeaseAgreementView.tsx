...
export const LeaseAgreementView: React.FC<LeaseAgreementViewProps> = ({
  ...
  const handleExportPdf = async () => {
    // If in form editor, automatically switch to preview tab so elements are rendered
      ...
      <div className={`space-y-8 ${activeSubTab === 'editor' ? 'hidden print:block' : 'block'}`}>
        ...
        <div className="bg-slate-900 border border-slate-700 rounded-2xl p-4 shadow-xl text-white print:hidden space-y-3">
          ...
          <div className="pt-3 border-t border-slate-800 flex flex-wrap items-center justify-between gap-4 text-xs">
            ...
            {/* Preview Scale Zoom */}
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-slate-400 font-medium text-[11px]">มุมมองหน้าจอ (Zoom):</span>
              <div className="flex items-center bg-slate-800 p-1 rounded-xl border border-slate-700">
                <button
                  type="button"
        ...
        {/* Scrollable Container with preview zoom scaling */}
        <div className="w-full overflow-x-auto pb-12 pt-2 flex flex-col items-center">
          <div
            className="space-y-8 flex flex-col items-center origin-top transition-transform duration-200 print:transform-none"
            style={{
        ...
        >
          <div>
            ...
            <div className={`${clauseGapClass} mb-3`}>
              ...
              <p className={`${enTextClass} text-justify indent-6 mt-0.5`}>
            ...
            <div className={clauseGapClass}>
              ...
              <div>
                ...
                <div className="pl-5 space-y-1 my-1.5 border-l-2 border-slate-400 bg-slate-50/50 p-2 rounded-r-lg">
                  ...
                  <p className={`${enTextClass} mt-0.5`}>
                ...
                <p className={`${enTextClass} text-justify indent-4 mt-0.5`}>
        ...
        >
          <div>
            {/* Header */}
            <div className="text-center border-b-2 border-slate-950 pb-2 mb-3">
              <h3 className="text-sm font-bold tracking-wide uppercase text-slate-950">
                สัญญาเช่าห้องพักเพื่อการอยู่อาศัย (หน้า 3/4)
              </h3>
              <p className="text-[11px] font-bold text-slate-700 tracking-wider">
                RESIDENTIAL LEASE AGREEMENT – RULES, TERMINATION & SIGNATURES
              </p>
            </div>

            <div className={clauseGapClass}>
              {/* Section 6: Maintenance & Prohibitions (Complete 6.1 - 6.4) */}
              <div>
                <div className={sectionHeadingClass}>
            ...
            <div className="pt-3 mt-2 border-t border-slate-300">
              <div className="grid grid-cols-2 gap-y-4 gap-x-8 text-center text-xs">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-700 font-sans">
                    <span>ลงชื่อ / Signed:</span>
                    <span className="inline-block border-b border-slate-400 w-36"></span>
                    <span className="font-medium whitespace-nowrap">ผู้ให้เช่า</span>
                  </div>
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-700 font-sans">
                    <span>ลงชื่อ / Signed:</span>
                    <span className="inline-block border-b border-slate-400 w-36"></span>
                    <span className="font-medium whitespace-nowrap">ผู้เช่า</span>
                  </div>
                  <div className="font-bold text-slate-950 text-sm">
                ...
                <div className="space-y-1 pt-1">
                  <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-700 font-sans">
                    <span>ลงชื่อ / Signed:</span>
                    <span className="inline-block border-b border-slate-400 w-36"></span>
                    <span className="font-medium whitespace-nowrap">พยาน</span>
                  </div>
                  <div className="font-semibold text-slate-800">
                    ({leaseData.witness1Name || <span className="inline-block border-b border-slate-300 w-28 align-middle"></span>})
                  </div>
                ...
                <div className="space-y-1 pt-1">
                  ...
                  <div className="font-semibold text-slate-800">
                    ({leaseData.witness2Name || <span className="inline-block border-b border-slate-300 w-28 align-middle"></span>})
                  </div>
            ...
            <div className="border border-slate-700 rounded overflow-hidden mb-3">
              <table className="w-full table-fixed text-left border-collapse text-[11.5px] font-sans">
                <thead className="bg-slate-100 text-slate-950 font-bold border-b border-slate-400">
                  <tr>
                    <th className="p-2 w-[8%] text-center border-r border-slate-300">ลำดับ<br/><span className="text-[10px] font-normal text-slate-600">No.</span></th>
                    <th className="p-2 w-[42%] border-r border-slate-300">รายการทรัพย์สินและอุปกรณ์<br/><span className="text-[10px] font-normal text-slate-600">Description of Furniture & Appliances</span></th>
                    <th className="p-2 w-[16%] text-center border-r border-slate-300">จำนวน<br/><span className="text-[10px] font-normal text-slate-600">Qty / Unit</span></th>
                    <th className="p-2 w-[20%] border-r border-slate-300">สภาพ ณ วันรับมอบ<br/><span className="text-[10px] font-normal text-slate-600">Condition at Handover</span></th>
                    <th className="p-2 w-[14%] text-center">หมายเหตุ<br/><span className="text-[10px] font-normal text-slate-600">Remark</span></th>
                  </tr>
                </thead>
              ...
              <div className="grid grid-cols-2 gap-8 text-center text-xs">
                <div className="space-y-1.5">
                  <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-700 font-sans">
                    <span>ลงชื่อ / Signed:</span>
                    <span className="inline-block border-b border-slate-400 w-36"></span>
                    <span className="font-medium whitespace-nowrap">ผู้ให้เช่า/ผู้ส่งมอบ</span>
                  </div>
                  <div className="font-bold text-slate-950 text-sm">
                    ({leaseData.lessorSignName || leaseData.lessorName})
                  </div>
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-700 font-sans">
                    <span>ลงชื่อ / Signed:</span>
                    <span className="inline-block border-b border-slate-400 w-36"></span>
                    <span className="font-medium whitespace-nowrap">ผู้เช่า/ผู้รับมอบ</span>
                  </div>
                  <div className="font-bold text-slate-950 text-sm">
                    ({leaseData.lesseeSignName || leaseData.lesseeName})
                  </div>
