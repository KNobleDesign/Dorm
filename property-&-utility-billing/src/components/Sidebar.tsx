...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  // - Owner (คุณแม่): dashboard, meter-entry, rooms, buildings, invoices, user-admin
  // - Staff (Caretaker): dashboard, meter-entry, rooms, invoices
  const allowedTabs: ActiveTab[] = isPloy
    ? ['dashboard', 'meter-entry', 'rooms', 'buildings', 'invoices', 'sheet-view', 'schema', 'ios-app', 'firebase-sync', 'gas-code', 'user-admin']
    : isOwner
      ? ['dashboard', 'meter-entry', 'rooms', 'buildings', 'invoices', 'user-admin']
      : ['dashboard', 'meter-entry', 'rooms', 'invoices'];
