            ...
            <form onSubmit={handleCreateUser} className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-3 animate-fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    <option value="ploy">💎 คุณพลอย (Super Admin ดูและแก้ไขได้ทุกระบบ)</option>
                    <option value="owner">👑 เจ้าของหอ (แดชบอร์ด จดมิเตอร์ ห้องพัก บิล จัดการผู้ใช้)</option>
            ...
            <form onSubmit={handleSaveEditUser} className="p-4 bg-indigo-50/60 border border-indigo-200 rounded-xl space-y-3 animate-fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    <option value="ploy">💎 คุณพลอย (Super Admin ดูและแก้ไขทุกอย่าง)</option>
                    <option value="owner">👑 เจ้าของหอ (ดูแดชบอร์ด จดมิเตอร์ ห้องพัก ใบแจ้งหนี้ จัดการผู้ใช้)</option>
