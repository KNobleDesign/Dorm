...
export const UserManagerModal: React.FC<UserManagerModalProps> = ({
  ...
  const handleCreateUser = (e: React.FormEvent) => {
    ...
    onAddUser({
      ...
      notes: newNotes.trim() || (newRole === 'ploy' ? 'คุณพลอย - Super Admin ดูและแก้ไขได้ทุกระบบ บันทึกลง Firebase เรียลไทม์' : newRole === 'owner' ? 'เจ้าของหอพัก (Owner) - แดชบอร์ด จดมิเตอร์ ห้องพัก จัดการอาคาร ใบแจ้งหนี้' : 'พนักงานดูแลหอพัก - กรอกมิเตอร์น้ำไฟ (ซ่อนข้อมูลเงิน)')
    });
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 animate-fade-in font-google-sans overflow-y-auto">
      <div className="bg-white rounded-2xl max-w-xl w-full my-auto shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[92vh]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="owner">👑 เจ้าของหอ (ดูแดชบอร์ด จดมิเตอร์ ห้องพัก จัดการอาคาร บิล การเงิน จัดการผู้ใช้)</option>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="owner">👑 เจ้าของหอ (ดูแดชบอร์ด จดมิเตอร์ ห้องพัก จัดการอาคาร ใบแจ้งหนี้ การเงิน จัดการผู้ใช้)</option>
