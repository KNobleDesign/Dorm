...
export const CaretakerCollectionSheet: React.FC<CaretakerCollectionSheetProps> = ({
  ...
  // Helper to cleanly shorten building name so it never truncates on A4
  const formatBuildingShortName = (b?: string): string => {
    if (!b) return '-';
    return b
      .replace(/^บ้านเช่า\s*/i, '')
      .replace(/^อาคาร\s*/i, '')
      .trim() || b;
  };
    ...
    return (
      ...
      >
        ...
        <thead>
          ...
          >
            <th style={{ padding: '3.5px 2px', textAlign: 'center', borderRight: '1px solid #334155', whiteSpace: 'nowrap' }}>ลำดับ</th>
            <th style={{ padding: '3.5px 3px', textAlign: 'left', borderRight: '1px solid #334155', whiteSpace: 'nowrap' }}>ชื่อตึก</th>
            <th style={{ padding: '3.5px 2px', textAlign: 'center', borderRight: '1px solid #334155', whiteSpace: 'nowrap' }}>ห้อง</th>
            <th style={{ padding: '3.5px 4px', textAlign: 'left', borderRight: '1px solid #334155', whiteSpace: 'nowrap' }}>คนเช่า</th>
            <th style={{ padding: '3.5px 4px', textAlign: 'right', borderRight: '1px solid #334155', whiteSpace: 'nowrap' }}>ยอดชำระ</th>
            <th style={{ padding: '3.5px 2px', textAlign: 'center', whiteSpace: 'nowrap' }}>จ่ายแล้ว</th>
          </tr>
        </thead>
        <tbody>
            ...
            return (
              ...
              >
                ...
                <td
                  ...
                  title={room.building}
                >
                  {formatBuildingShortName(room.building)}
                </td>
