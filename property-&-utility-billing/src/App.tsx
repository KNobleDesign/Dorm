...
const STORAGE_KEYS = {
  ...
  ROOMS: 'propmanage_rooms_by_month_v4',
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const handleRemoteRooms = (remoteRoomsByMonth: Record<string, RoomRecord[]>) => {
      ...
      // Ensure September (start month) has zero past arrears/debts
      if (merged['09 ก.ย.']) {
      ...
      Object.keys(rawData).forEach((monthKey) => {
        cleanedData[monthKey] = (rawData[monthKey] || [])
          ...
          .map((room) => {
            ...
            // In September (the initial master data month), there are strictly no arrears or past debt
            if (monthKey === '09 ก.ย.') {
              return {
                ...room,
                otherFees: 0,
