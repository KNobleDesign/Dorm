...
export const RAW_SEPTEMBER_SPECS: RawRoomSpec[] = [
  ...
  { key: 'FAC-01', buildingId: 'BLD-FAC01', building: 'อาคารโรงงาน', roomNo: '1', tenantName: 'คุณ ฮัน', elecCurr: 3277, elecPrev: 3200, occupants: 1, waterCalcType: 'per_person', rent: 1700, waterRate: 20, elecRate: 8.5 },
  ...
  { key: 'FAC-03', buildingId: 'BLD-FAC01', building: 'อาคารโรงงาน', roomNo: '3', tenantName: 'คุณ เอ๋', elecCurr: 2448, elecPrev: 2400, occupants: 1, waterCalcType: 'per_person', rent: 0, waterRate: 20, elecRate: 8.5 },
  { key: 'FAC-04', buildingId: 'BLD-FAC01', building: 'อาคารโรงงาน', roomNo: '4', tenantName: 'คุณ หน่า', elecCurr: 373, elecPrev: 350, occupants: 1, waterCalcType: 'per_person', rent: 0, waterRate: 20, elecRate: 8.5 },
  ...
  { key: 'FAC-07', buildingId: 'BLD-FAC01', building: 'อาคารโรงงาน', roomNo: '7', tenantName: 'คุณ เออนัน', elecCurr: 8423, elecPrev: 8350, occupants: 3, waterCalcType: 'per_person', rent: 1000, waterRate: 20, elecRate: 8.5 },
  ...
  { key: 'FAC-13', buildingId: 'BLD-FAC01', building: 'อาคารโรงงาน', roomNo: '13', tenantName: 'คุณ เปิ้ล', elecCurr: 7467, elecPrev: 7400, occupants: 2, waterCalcType: 'per_person', rent: 1700, waterRate: 20, elecRate: 8.5 },
  { key: 'FAC-14', buildingId: 'BLD-FAC01', building: 'อาคารโรงงาน', roomNo: '14', tenantName: 'ใจชบาไพร2', elecCurr: 7481, elecPrev: 7400, occupants: 1, waterCalcType: 'per_person', rent: 0, waterRate: 20, elecRate: 8.5 },
  { key: 'FAC-15', buildingId: 'BLD-FAC01', building: 'อาคารโรงงาน', roomNo: '15', tenantName: 'แหม่มร้าน2', elecCurr: 4732, elecPrev: 4680, occupants: 1, waterCalcType: 'per_person', rent: 0, waterRate: 20, elecRate: 8.5 },

  // 2. อาคาร 399/38 (18 ห้อง, ค่าน้ำเหมา 100บ./คน, ไฟ 8)
  ...
  { key: '399-38-01-2', buildingId: 'BLD-399-38', building: 'อาคาร 399/38', roomNo: '1-2', tenantName: 'คุณ ณเดชน์ (มิเตอร์ 1)', elecCurr: 1482, elecPrev: 1450, occupants: 1, waterCalcType: 'per_person', rent: 0, waterRate: 18, elecRate: 8 },
  ...
  { key: 'DM-02', buildingId: 'BLD-DM01', building: 'อาคาร ดอนเมือง', roomNo: '2', tenantName: 'คุณชบัญทิตา', elecCurr: 2328, elecPrev: 2250, waterCurr: 448, waterPrev: 435, occupants: 1, waterCalcType: 'meter', rent: 2800, waterRate: 18, elecRate: 8 },
  ...
  { key: 'DM-16', buildingId: 'BLD-DM01', building: 'อาคาร ดอนเมือง', roomNo: '16', tenantName: 'คุณ (ผู้เช่า)', elecCurr: 9630, elecPrev: 9540, waterCurr: 553, waterPrev: 538, occupants: 1, waterCalcType: 'meter', rent: 2000, waterRate: 18, elecRate: 8 },
  ...
  { key: 'DM-19', buildingId: 'BLD-DM01', building: 'อาคาร ดอนเมือง', roomNo: '19', tenantName: 'คุณ เคท', elecCurr: 6376, elecPrev: 6300, waterCurr: 377, waterPrev: 365, occupants: 1, waterCalcType: 'meter', rent: 2000, waterRate: 18, elecRate: 8 },
...
export function buildRoomRecord(spec: RawRoomSpec, monthIndex: number, monthStr: string): RoomRecord {
  ...
  const isVacant = spec.status === 'vacant' || spec.tenantName === 'ห้องว่าง' || spec.rent === 0;
  ...
  if (isOccupied) {
    if (spec.waterCalcType === 'per_person') {
      waterUnits = 0;
      waterCost = (spec.occupants || 1) * 100;
    } else {
  ...
  // In September (monthIndex 8), some rooms are paid, some pending
  const isPaid = isOccupied ? (monthIndex < 8 ? true : (monthIndex === 8 ? (parseInt(spec.roomNo.replace(/\D/g, '') || '1', 10) % 3 === 0) : false)) : false;
  ...
  return {
    ...
    phone: '',
    occupants: spec.occupants || (isOccupied ? 1 : 0),
    occupancyStatus,
    isOccupied,
