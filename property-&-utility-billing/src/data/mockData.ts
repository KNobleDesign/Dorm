...
export const DEFAULT_APP_USERS: AppUser[] = [
  {
    ...
    phone: '081-987-6543',
    pinCode: '1234',
    notes: 'เจ้าของหอพัก (Owner) - สิทธิ์เต็มทุกระบบ ดูยอดเงิน กำไร จัดการผู้ใช้งานระบบ (เปลี่ยนชื่อ/รหัสผ่านได้ในระบบ)',
  ...
  },
  {
    ...
    phone: '089-123-4567',
    pinCode: '0891234567',
    notes: 'ผู้ใช้งานทั่วไป / พนักงานดูแล (User) - มีสิทธิ์จด/กรอกมิเตอร์น้ำไฟ บันทึกเลขห้อง (ไม่มีสิทธิ์จัดการผู้ใช้)',
...
export const DEFAULT_LANDLORD_CONFIG: LandlordConfig = {
  ...
  bankAccount: '743-2-89012-3 (บัญชีออมทรัพย์ นายประดิษฐ์ เจริญสุขสิริ)',
