...
import { SEPTEMBER_BUILDINGS, generateAllSeptemberRooms } from './septemberRooms';
...
export const DEFAULT_BUILDINGS: BuildingProfile[] = SEPTEMBER_BUILDINGS;
...
export const INITIAL_ROOMS_DATA: Record<string, RoomRecord[]> = generateAllSeptemberRooms();
