...
export const DEFAULT_BUILDINGS: BuildingProfile[] = [
  ...
  {
    id: 'BLD-HOUSE01',
    name: 'บ้านเช่า (Rental House)',
    totalUnits: 4,
    location: '55/12 ซอยวิภาวดี 60 แขวงตลาดบางเขน เขตหลักสี่ กรุงเทพมหานคร 10210',
    floors: 2,
    defaultWaterRate: 18,
    defaultElecRate: 8,
    description: 'บ้านเช่าเดี่ยวและทาวน์โฮมให้เช่า พร้อมที่จอดรถส่วนตัว รับเงินเข้าบัญชีบ้านเช่า (SCB)',
    paymentAccountOption: 'house',
