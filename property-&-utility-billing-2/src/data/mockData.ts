...
export const DEFAULT_APP_USERS: AppUser[] = [
  {
    ...
    phone: '084-041-1115',
    pinCode: '0840411115',
    notes: 'คุณพลอย (Ploy) - ผู้ดูแลระบบสูงสุด (Super Admin): สิทธิ์เต็ม ดูและแก้ไขได้ทุกระบบ อัปเดตและบันทึกลง Cloud Firebase แบบเรียลไทม์',
